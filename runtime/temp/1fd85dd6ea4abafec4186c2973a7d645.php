<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/www/wwwroot/vip.guochamall.com/public/../application/partner/view/recharge/storeindex.html";i:1528270588;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    $(function () {
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('recharge/storeData'); ?>",
        ...
        $("#html").on("click",".btn",function () {
            ...
            $.ajax({
                url:"<?php echo url('recharge/cookie_store'); ?>",
                data:{id:id},
                type:"post",
