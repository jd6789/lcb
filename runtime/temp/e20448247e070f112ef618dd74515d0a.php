<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/vip.guochamall.com/public/../application/tmvip/view/report/index.html";i:1524828036;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="contviewtab">
    ...
    <a href="<?php echo URL($v['module_name'].'/'.$v['controller_name'].'/'.$v['action_name']); ?>"
        target="bbb" <?php if($v['parent_id'] == $url): ?> class="curr" <?php else: ?>style="display: none;"<?php endif; ?>><?php echo $v['rule_name']; ?></a>
    <?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<div class="bench white-scroll">
    <iframe src="<?php echo URL('tmvip/Report/consumption'); ?>" frameborder="0" name="bbb"></iframe>
