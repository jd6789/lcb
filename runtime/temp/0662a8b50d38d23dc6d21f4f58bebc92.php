<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/vip.guochamall.com/public/../application/newapp/view/user/confirm.html";i:1529916237;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
      <div class="content"><!--content-->
          ...
          <div class="total">
              ...
              <p class="total-jf">赠<?php echo $recharge['total_inte']; ?>积分</p>
          </div>
        ...
        var payid = getUrlParam("id")//获取当前地址信息
          if (isWeiXin()) {
            ...
            $("#ljfk").click(function(){
              ...
              //weixin1
              if(pay_v == 1){
                window.location.href="http://news.163.com/";
              }
            })
