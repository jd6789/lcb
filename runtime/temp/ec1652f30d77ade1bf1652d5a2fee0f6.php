<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/www/wwwroot/vip.guochamall.com/public/../application/partner/view/recom/recommen.html";i:1530695793;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="content">
    ...
    <div style="margin-bottom: 0.2rem;padding:0.2rem 0.3rem;" class="count">一级市场：<span id="one"><?php echo $data['one_num']; ?></span>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;二级市场：<span
            id="two"><?php echo $data['two_num']; ?></span>人<br>团队市场：<span id="team"><?php echo $data['one_num'] + $data['two_num']; ?></span>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总入股数：<span id="grade"><?php echo $data['partner']; ?></span>份
    </div>
</div>
<div id="tab1">
    <table id="table">
...
<script>
    ...
    function getData(curPage) {
        $.ajax({
            type: "POST",
            url: "<?php echo url('recom/recommenders'); ?>",
            dataType: "json",
            ...
            success: function (data) {
                if (data.status==0 || data=="" ||data==0) {
                    ...
                    for (var i = curPage1; i < count; i++) {
                        str += "<tr><td>" + data[i].user_name + "</td><td></td><td>" + data[i].gufen + "份</td></tr>";
                    }
