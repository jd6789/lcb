<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/www/wwwroot/vip.guochamall.com/public/../application/tmvip/view/store/allceoindex.html";i:1527134084;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="globaltable r5px">
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="username"><?php echo $v['stores_name']['stores_name']; ?></td>
                <td class="username"><?php echo $v['user_name']['user_name']; ?></td>
                <td class="username"><?php echo $v['addtime']; ?></td>
                <td class="username"><?php echo $v['gufen']; ?>%</td>
                <td>
                    <button value="<?php echo $v['id']; ?>" class="allss">股权调整</button>
