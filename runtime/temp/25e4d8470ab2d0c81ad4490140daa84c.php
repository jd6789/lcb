<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/www/wwwroot/vip.guochamall.com/public/../application/tmvip/view/user/integral_chart.html";i:1525228894;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    function getDate2_1(curPage, time1, time2) {
        ...
        $.ajax({
            url: "<?php echo URL('tmvip/User/integral_chart'); ?>",
            type: "post",
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.list.length; i++) {
                    for (var j = 0; j < data['list'][i].length; j++) {
                        ...
                        var grade = data['list'][i][j]['surplus_inte'][j];//释放
                        var cz = data['list'][i][j]['tea_inte'][j];//茶券
                        var cz1 = data['list'][i][j]['tea_ponit_inte'][j];//茶点
                        names += ",'" + name + "'";
                        grades += "," + grade + "";
                        place += "," + cz + "";
                        place1 += "," + cz1 + "";
            ...
            success: function (data) {
                ...
                for (var i = curPage; i < count; i++) {
                    ...
                    str += "<tr>"+
                        ...
                        "<td>"+data.list1[i]['tea_inte']+"</td>"+
                        "<td>"+data.list1[i]['tea_ponit_inte']+"</td>"+
