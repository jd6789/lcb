<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/www/wwwroot/vip.guochamall.com/public/../application/partner/view/recom/otherreg.html";i:1528969626;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    ...
    $("#J_Register").click(function(){
        ...
        $.ajax({
            type:"post",
            url:"<?php echo url('api/api/otherreg'); ?>",
            dataType:'json',
            data:{
                'username':username,
                'name':re_username,
            ...
            success:function(msg){
                if(msg.status == 1){
                    layer.msg("注册成功");
                    setTimeout(function(){
                        location.href="<?php echo url('index/custom_info'); ?>";
                    },1000);
                }
                if(msg.status == 2){
                    layer.msg("服务器维护中");
