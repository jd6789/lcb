<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"/www/wwwroot/vip.guochamall.com/public/../application/partner/view/recharge/confirm_buy_new.html";i:1543217662;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="mendian">
        <ul>
            ...
            <li  style="list-style-type:none; border-bottom:1px solid #e9ecf1">
                <a href="<?php echo url('recharge/storeindex_new'); ?>" >入股门店<span class="right" style="font-weight:bold;font-size: 15px; "><?php echo $store['stores_name']; ?><span>></span></span></a>
            </li>
...
<script>
    $(function () {
        ...
        $("#buy").click(function () {
            ...
            $.ajax({
                url:"<?php echo url('recharge/buyManage_new'); ?>",
